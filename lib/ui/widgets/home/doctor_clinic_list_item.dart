...
class DoctorlinicListItem extends StatelessWidget {
  final Clinic clinic;
  final int doctor;

  const DoctorlinicListItem({Key key, this.clinic, this.doctor})
      : super(key: key);
  @override
              ...
              children: <Widget>[
                ...
                OutlineButton(
                  onPressed: () => Navigator.pushNamed(
                      context, RoutePath.appointment_create,
                      arguments: {'doctor_id': doctor, 'clinic_id': clinic.id}),
